...
<<<<<<< Updated upstream
            ...
            Console.WriteLine(p.toString());
=======
            // affichage buggy si changement de taille de la console, fixable en clear a chaque fois puis réecriture.
            Console.WriteLine("Please put the screen in full screen mode and press any key to continue");
            Console.ReadKey();
